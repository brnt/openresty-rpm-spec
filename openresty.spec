...
%build
./configure --with-ipv6 --with-pcre-jit --with-http_geoip_module --with-http_stub_status_module --with-http_realip_module --with-http_v2_module --with-http_slice_module --with-http_auth_request_module --with-http_dav_module 
make %{?_smp_mflags}
